...
class VAE(nn.Module):
    ...
    '''
    def __init__(self, inChans=256, outChans=4, dense_features=(10,12,8), activation="relu", normalization="group_normalization", mode="trilinear"):
...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        return out_en0, out_en1, out_en2, out_en3
...
class Decoder(nn.Module):
    ...
    def forward(self, out_en0, out_en1, out_en2, out_en3):
...
class NvNet(nn.Module):
    ...
    def forward(self, x):
        out_en0, out_en1, out_en2, out_en3 = self.encoder(x)
        out_end = self.decoder(out_en0, out_en1, out_en2, out_en3)
